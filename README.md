...
![gitsocial](https://repo.x-cmd.io/gitsocial.svg)
...
Total: **162,286** lines of code across **774** files in the top 5 languages.
...
- **Latest**: `v0.24.0` (2026-09-08)
- **Last commit**: 2026-09-09
- **Assets in release**: 11

## Popularity

- **Stars**: 122 · **Forks**: 4 · **Open issues**: 0 · **Contributors**: 4

## Totals (cumulative)

- **Releases**: 54 · **Merged PRs**: 0 · **Open PRs**: 0 · **Closed issues**: 0 · **Open issues**: 0 · **Commits**: 258

## Recent activity

| Window | Since | Releases | Merged PRs | Open PRs | Closed issues | Open issues | Commits |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-17 | 3 | 0 | 0 | 0 | 0 | 38 |
| last60d | 2026-07-18 | 8 | 0 | 0 | 0 | 0 | 77 |
| 90d | 2026-06-18 | 16 | 0 | 0 | 0 | 0 | 130 |
| last180d | 2026-03-20 | 35 | 0 | 0 | 0 | 0 | 221 |
| 360d | 2025-09-21 | 54 | 0 | 0 | 0 | 0 | 257 |
| last720d | 2024-09-26 | 54 | 0 | 0 | 0 | 0 | 258 |
...
Install metadata for gitsocial lives in the [x-cmd/install](https://github.com/x-cmd/install) index — a curated YAML package list that x-cmd consumes at install time. If `gitsocial` is missing, out of date, or installs incorrectly, please open an issue or PR there:

- **Open an issue**: <https://github.com/x-cmd/install/issues/new>
- **Edit the package entry**: <https://github.com/x-cmd/install/edit/main/gitsocial.yml> (or whichever path the index uses)

The data on this page (card / loc / scorecard / release) is auto-collected by [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) and is regenerated daily. Improvements to *install behaviour* (which version gets installed, platform-specific quirks, dependencies) belong upstream in the index.

_Snapshot: `data/card/260916.yml` · 2026-09-16T06:23:57Z._
